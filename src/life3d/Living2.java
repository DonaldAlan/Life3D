 ...
 *
 */
public class Living2 extends Application {
	...
	private static double newSizeFactor=0.491; // For depth=5, 0.495;
	//--------------
...
//			group.setTranslateZ(z);
	...
	private static void randomizeColorsAndMaterials() {
		...
		for(int i=0;i<NUMBER_OF_HSB_COLORS;i++) {
			Color color =  Color.hsb((360.0*i)/NUMBER_OF_HSB_COLORS, 0.9,0.6); 
...
//				running=false;
				if (nowInNanoSeconds-last[0]<millisecondsToSleepBetweenFrames*ONE_MILLISECOND_IN_NANOSECONDS) {
					return;
				}
